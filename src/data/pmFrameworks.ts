...
{recommendation}`,
    fields: [
      ...
      {
        id: 'recommendation',
        label: 'Your Initial Thoughts (optional)',
        type: 'textarea',
        required: false,
        placeholder: 'Any initial prioritization thoughts or constraints...',
      },
    ],
  },
  {
...
- {opportunity3}`,
    fields: [
      ...
      },
      {
        ...
        type: 'textarea',
        required: false,
        placeholder: 'e.g., Takes too long to find the right option',
      },
      {
        id: 'painPoint2',
        label: 'Pain Point 2',
        type: 'textarea',
        required: false,
        placeholder: 'e.g., Unclear pricing or hidden fees',
      },
      {
        id: 'painPoint3',
        label: 'Pain Point 3',
      ...
      },
      {
        ...
        type: 'textarea',
        required: false,
        placeholder: 'e.g., Streamline the decision-making process',
      },
      {
        id: 'opportunity2',
        label: 'Opportunity 2',
        type: 'textarea',
        required: false,
        placeholder: 'e.g., Offer transparent upfront pricing',
      },
      {
        id: 'opportunity3',
        label: 'Opportunity 3',
        type: 'textarea',
        required: false,
        placeholder: 'e.g., Build a first-class mobile experience',
      },
    ],
  },
];