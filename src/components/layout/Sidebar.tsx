...
export const Sidebar: React.FC = () => {
  ...
  const handleNewConversation = () => {
    ...
    setCurrentConversation(null); // Reset to "New Chat" state (clears files) instead of creating immediately
    // Keep sidebar open like original
  };
  ...
  return (
    <div
      className={ `fixed inset-y-0 left-0 w-80 bg-white dark:bg-gray-900 border-r border-gray-200 dark:border-gray-700 z-50 flex flex-col shadow-lg transform transition-transform duration-500 ease-in-out ${sidebarOpen ? "translate-x-0" : "-translate-x-full"
        }` }
      onMouseEnter={ () => {
